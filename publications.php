<!DOCTYPE html>
<html lang="en">
    <title>PUBLICATIONS PAGE | Biofeedback South Africa</title>
<head>
<?php
...
<?php
    ...
    if ($_SESSION["publication_success"] == 1) {
        echo '<script>swal("Success!", "Publication added!", "success");</script>';
        $_SESSION["publication_success"] = 0;
    };
...
?>
    ...
    <div style="text-align:center;border-bottom: 2px solid #02a7e3;">
        ...
        <h4>Click on a publication to read</h4>
    </div>
                        ...
                        if ($results[$i]["permission"] == 1) {
                            if ($_SESSION["member"] > 1) {
                                ...
                                echo '<div class="panel2" id="panel',$results[$i]["id"],'">';
                                    if ($_SESSION["admin"] == 1) {
                                        echo '<div style="display:flex;"><a class="delBut" onclick="return confirm(`Are you sure you want to delete this?`);" href="PHP/del_publication.php?id=',$results[$i]["id"],'">DELETE</a><br>';
                                        echo '<a style="margin-left:20px;" class="editBut" onclick="return confirm(`Are you sure you want to edit this?`);" href="edit.php?id=',$results[$i]["id"],'&page=publications">EDIT</a><br></div>';
                                    }
                                    echo "<h1>",$results[$i]["title"],"</h1>";
                                echo "<p>Posted on: ",$results[$i]["cr_date"],"</p>";
